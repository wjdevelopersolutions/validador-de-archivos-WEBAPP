!(function (e) {
    ...
    (e.FileDialog = function (a) {
        var o = e.extend(e.FileDialog.defaults, a),
            t = e(
                [
                    ...
                    "                <button type='button' class='btn btn-success bfd-ok'>",
                    "                <i class='icofont icofont-tools icofont-2x mr-1'></i>"
                    ,
                    o.ok_button,
                    "                </button>",
                    "                <button type='button' class='btn btn-outline-success bfd-cancel'",
                    "                                data-dismiss='modal'>",
                    "                 <i class='icofont icofont-ui-close icofont-1x mr-1'></i>",
                    o.cancel_button,
                    "                </button>",
                    "            </div>",
                    "        </div>",
        ...
        s.css({ height: o.dropheight, "padding-top": o.dropheight / 2 - 32 }),
            r.attr({ accept: o.accept, multiple: o.multiple }),
            ...
            c = function (a) {
                ...
                var s = e(
                    [
                        ...
                        "</div>",
                        "<div class='col-xs-5 col-sm-8 bfd-progress' style='margin-top: 8px;'>",
                        "    <div class='progress'>",
                ...
                (n = e(".progress-bar", s)),
                    e(".bfd-remove", s)
                        .tooltip({ container: "body", html: !0, placement: "top", title: o.remove_message })
                    ...
                    (r = e("<div class='row'></div>")),
                    r.append(s),
                    e(".bfd-files", t).append(r),
                    i["readAs" + o.readAs](a);
            },
            f = function (e) {
